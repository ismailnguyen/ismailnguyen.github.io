<template>
    <div class="wrapper">
                ...
                <div class="clip-svg">
                    <div class="night">
                        ...
                        <div class="car suspension">
                            <img src="/resources/images/404/Img_06.png" alt="">
                        </div>
                    </div>
                </div>
                <svg id="Layer_1" data-name="Layer 1" viewBox="0 0 809.39 555.27">
                    <defs>
        ...
        <div class="mobile-view">
            <img src="/resources/images/404/72.jpg" alt="">
        </div>
        <div class="tablet-view">
            <img src="/resources/images/404/27.jpg" alt="">
        </div>
